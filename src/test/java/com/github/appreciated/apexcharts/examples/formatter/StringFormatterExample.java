...
public class StringFormatterExample extends ApexChartsBuilder {

    public StringFormatterExample() {
        withChart(ChartBuilder.get()
                ...
                .withXaxis(XAxisBuilder.get().withLabels(LabelsBuilder.get().withFormatter(new StringFormatter()).build()).build())
                .withYaxis(YAxisBuilder.get().withLabels(com.github.appreciated.apexcharts.config.yaxis.builder.LabelsBuilder.get().withFormatter(new StringFormatter()).build())
                        .build());
    }
}
