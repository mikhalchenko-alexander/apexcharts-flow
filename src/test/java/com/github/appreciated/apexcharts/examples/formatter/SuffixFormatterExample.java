...
public class SuffixFormatterExample extends ApexChartsBuilder {

    public SuffixFormatterExample() {
        withChart(ChartBuilder.get()
                ...
                .withXaxis(XAxisBuilder.get().withLabels(LabelsBuilder.get().withFormatter(new SuffixFormatter(" foobar")).build()).build())
                .withYaxis(YAxisBuilder.get().withLabels(com.github.appreciated.apexcharts.config.yaxis.builder.LabelsBuilder.get().withFormatter(new SuffixFormatter(" foobar")).build())
                        .build());
    }
}
