...
public class IntFormatterExample extends ApexChartsBuilder {
    ...
    public IntFormatterExample() {
        withChart(ChartBuilder.get()
                ...
                .withXaxis(XAxisBuilder.get().withLabels(LabelsBuilder.get().withFormatter(new IntFormatter()).build()).build())
                .withYaxis(YAxisBuilder.get().withLabels(com.github.appreciated.apexcharts.config.yaxis.builder.LabelsBuilder.get().withFormatter(new IntFormatter()).build())
                        .build());
    }
}
